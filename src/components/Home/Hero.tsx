...
const Hero = () => (
    <div className="flex justify-center flex-col md:flex-row sm:flex-row p-10 gap-10 2xl:gap-20 xl:min-w-full">
        ...
        <div className="flex flex-col justify-center gap-5 xl:w-2/6" >
                ...
                <p className="text-5xl font-bold dark:text-white xl:text-8xl">Estimate your carbon footprint</p>
         
            <div className="flex">
                <Link href="/register">
                     <button type="button" className="focus:outline-none text-grey font-bold bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 xl:text-xl">Start here</button>
                </Link>
